...
## Data Analysis   
Principal component analysis was applied to filtered and TMM-normalized expression data to identify developmental clusters that account for expression variability between *S. stercoralis* life stages stages. 
...
## Update Notes
* This code was updated on 11-03-21 to add *S. stercoralis* free-living male RNA-seq expression data (ASB).
* Re-ran this plot on 11-06-21 after reprocessing Kallisto alignment with WBPS16 transcriptome (ASB)
* Re-ran this plot on 07-11-22 after reprocessing Kallisto alignment with WBPS17 transcriptome (ASB)
