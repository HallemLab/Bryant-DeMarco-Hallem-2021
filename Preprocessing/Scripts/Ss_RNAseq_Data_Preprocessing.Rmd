...
# Introduction
The goal of this file is to pre-process the *Strongyloides stercoralis* RNA-seq dataset originally published by [Stolzfus *et al* 2012](https://journals.plos.org/plosntds/article?id=10.1371/journal.pntd.0001854). 
...
p1<-ggplot(myTPM.stats) + 
  ...
  labs(y="Median", x = "Standard deviation",
       ...
       caption="S. stercoralis Stoltzfus RNA-seq Dataset") +
  theme_bw()
p1
